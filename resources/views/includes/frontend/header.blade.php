<!-- Top Nav Start here -->
<div class="top-row innerNav">
    <div class="container">
        <div class="dFlex">
            <div><a href="{{ route('index') }}"><img class="topLogo" alt="Hero Fit" title="Hero Fit"
                        src="{{ asset('assets/images/footer-logo.png') }}" /></a></div>
            <div>
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                @auth
                                    ...
                                    <a href="{{ route('user.cart') }}"><img alt="icon"
                                            src="{{ asset('assets/images/bag-icon-black.png') }}" /></a>
                                @else
                            ...
                            @auth
                                <div class="dropdown">
                                    <li id="menu2" data-toggle="dropdown" class="nav-item">
                                        <div class="userSec dropdown-toggle">
                                            <div class="suserImg">
                                                @if (Auth::user()->image)
