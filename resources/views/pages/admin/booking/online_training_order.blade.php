    ...
    <div class="admin-body-area">
        ...
        <div class="booking-status-sec variation-list-sec">
            <div class="category-list-hdn">
                <h2>Online Training Order Management</h2>
                <h3 class="create-cat">
                                ...
                                @foreach ($dataArr['bookingArr'] as $booking)
                                    <tr>
                                        <td title="Booking Number">
                                            <a href="{{ route('admin.online.training.order.view', $booking->id) }}"
                                                title="View">
                                        ...
                                        <td title="Action">
                                            <div class="doted-dropdown">
                                                ...
                                                <div class="doted-dropdown-content">
                                                    @if (@$booking->status == 'active')
                                                        <a href="{{ route('admin.online.training.order.status', [$booking->id, 'delivered']) }}"
                                                            title="Delivered" class="status-confirm">
                                                            <i class="fa fa-shopping-cart views"></i>
                                                        </a>
                                                        <a href="{{ route('admin.online.training.order.status', [$booking->id, 'cancel']) }}"
