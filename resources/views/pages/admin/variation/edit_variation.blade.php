    ...
    <div class="admin-body-area">
        ...
        <div class="booking-status-sec variation-list-sec">
            ...
            <div class="variation-list-area">
                <form action="{{ route('admin.variation.update', $dataArr['variationArr']->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id" required="">
                                    ...
                                    @foreach ($dataArr['parentCategoryArr'] as $pCat)
                                        <option value="{{ $pCat->id }}" {{ $pCat->id == $dataArr['variationArr']->category_id ? 'selected' : '' }}>{{ $pCat->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div> --}}
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control"
                                    value="{{ $dataArr['variationArr']->name }}" required="">
                            </div>
                        </div>
                    </div>
