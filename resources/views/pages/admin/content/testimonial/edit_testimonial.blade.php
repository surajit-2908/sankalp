    ...
    <div class="admin-body-area">
        ...
        <div class="booking-status-sec testimonial-list-sec">
            ...
            <div class="testimonial-list-area">
                <form action="{{ route('admin.testimonial.update', $dataArr['testimonialArr']->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control"
                                    value="{{ $dataArr['testimonialArr']->name }}" required="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="designation" class="form-control"
                                    value="{{ $dataArr['testimonialArr']->designation }}" required="">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                <label>Comment</label>
                                <textarea class="form-control" name="comment" rows="6" required="">{!! str_replace('<br />', '', $dataArr['testimonialArr']->comment) !!}</textarea>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12 col-md-12 show-img">
                            <img id="showImg"
                                src="{{ asset('storage/testimonial_image/') . '/' . $dataArr['testimonialArr']->image }}">
                        </div>
                    </div>
