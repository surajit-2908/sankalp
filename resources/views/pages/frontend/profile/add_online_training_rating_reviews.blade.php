        ...
        <div class="container">
            ...
            <div class="ratingReviewBdyPrt">
                <div class="ratingArea">
                    ...
                    <div class="previousRate">
                        <div class="previousRateTextClm">
                            ...
                            <p><span>{{ onlineTrainingRatingCal($onlineTraining->id)['avgRating'] }} <i class="fa fa-star"
                                        aria-hidden="true"></i></span>{{ onlineTrainingRatingCal($onlineTraining->id)['ratingCount'] }}
                            </p>
                        </div>
                        <div class="previousRateImgClm" onclick="window.location='{{ route('online.training') }}'">
                ...
                <div class="reviewArea">
                    ...
                    <form method="post" action="{{ route('user.save.online.training.rating', [$booking_number]) }}"
