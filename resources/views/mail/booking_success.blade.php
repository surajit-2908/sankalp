        ...
        <div style="max-width:620px; border:1px solid #f0f0f0; margin:0 0; padding:15px; ">
            ...
            <div style="display:block;overflow:hidden; width:100%; margin: 5px 0px 0px 0px;">
                <p style="font-family:Arial; font-size:14px; font-weight:500; text-align:center;">
                    We’re happy to let you know that we’ve received your order. Your order will be delivered soon.
                </p>
            </div>
            {{-- <div style="display:block;overflow:hidden; width:100%; text-align:center; margin: 0px 0px 10px 0px;">
                <a href="{{ route('update.booking', $booking['booking_no']) }}"
                    style="font-family:Arial; border-radius:17px;font-size:15px; font-weight:500; color:#FFF; display:inline-block; padding: 7px 12px; background:#41b749; text-decoration:none;">Modify
                    Booking</a>
            </div> --}}
                                    ...
                                    <div>
                                        ...
                                        @if ($variationArr)
                                            @foreach (@$variationArr as $variation => $varOpt)
                                                <p style="margin: 0px;"><b>{{ $variation }} -</b> {{ $varOpt[0] }}</p>
                                            @endforeach
                                        @endif
                                    </div>
                                </div>
                    ...
                    <tr>
                        ...
                        <td title="Estimated Total" style="padding: 3px 0px;">
                            <h3 style="font-size: 16px;font-family:Arial; margin: 0px;text-align: right;">
                                ${{ number_format(@$booking['booking_detail']->total_amount, 2) }}</h3>
